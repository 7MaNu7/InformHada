...
namespace WebApplication1
{
    public partial class VerMasUsuarios : System.Web.UI.Page
    {
        ...
        private DataSet d_aux = new DataSet();
        ...
        {
            usuario = (FilmBiblio.UsuarioEN)Session["usuario"];
            d_aux = usuario.DameAmigos(0);      

            if (d_aux.Tables[0].Rows.Count != 0)
            {
            ...
            if ((d_aux.Tables[0].Rows.Count == 0) || (d_aux.Tables[0].Rows.Count != 0 && d.Tables[0].Rows.Count == 0))
