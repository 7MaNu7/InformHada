   ...
   <div class="contenido">
        ...
        <div class="pelicula_contenido">
            ...
            <div class="pelicula_contenido_d">
               <h2>Sinopsis</h2>
               <p> <asp:TextBox ID="TextBoxSinopsis" runat="server"  TextMode="MultiLine" style="height:131px; width:945px;" placeholder="Escriba la sinopsis de la película aquí"></asp:TextBox> </p>
